 ...
 */
export declare const MESSAGE_STREAM_EVENT: {
    /** Text chunk during streaming. First chunk indicates stream start. */
    readonly messageStreamChunk: "messageStreamChunk";
    /** Error occurred during streaming */
    readonly messageStreamError: "messageStreamError";
    /** Complete message broadcast (existing event, indicates stream end) */
    readonly messageBroadcast: "messageBroadcast";
};
